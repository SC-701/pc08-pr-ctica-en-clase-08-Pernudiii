...
namespace Servicios
{
    public class RevisionServicio : IRevisionServicio
    {
        ...
        {
            var endPoint = _configuracion.ObetenerMetodo("APIEndpointsRevision", "ObtenerRevision");
            ...
            var resultadoDesrelizado = JsonSerializer.Deserialize<IEnumerable<Revision>>(resultado,opciones);

            return resultadoDesrelizado.FirstOrDefault();
        }
    }
}
