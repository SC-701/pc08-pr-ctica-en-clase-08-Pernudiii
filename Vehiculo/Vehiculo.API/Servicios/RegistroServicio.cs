...
namespace Servicios
{
    public class RegistroServicio : IRegistroServicio
    {
        ...
        public async Task<Propietario> Obtener(string placa)
        {
            ...
            var endPoint = _configuracion.ObetenerMetodo("APIEndpointsRegistro", "ObtenerRegistro");
            ...
            var resultadoDesrelizado = JsonSerializer.Deserialize<List<Propietario>>(resultado,opciones);
